...
#'Revenue','Gross_Profit','Net_Income','Net_Income_Com','EPS_Diluted','Weighted_Average_Shs_Out_(Dil)','EBIT_Margin','Profit_Margin','Free_Cash_Flow_margin','Consolidated_Income','Net_Profit_Margin','Cash_and_short-term_investments','Total_non-current_assets','Free_Cash_Flow','priceEarningsToGrowthRatio','ebitperRevenue','niperEBT','pretaxProfitMargin','netProfitMargin','returnOnAssets','eBITperRevenue','Return_on_Tangible_Assets','3Y_Net_Income_Growth_(per_Share)','Book_Value_per_Share_Growth'
# load the data
